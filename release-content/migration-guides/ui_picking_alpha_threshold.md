...
transparency), set the picking mode back to `UiPickingMode::BoundingBox`:
...
commands.spawn((
    Node::default(),
    ImageNode::new(image),
    // This node uses a bounding-box check even though the global default is an alpha threshold.
